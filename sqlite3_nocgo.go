...
func Version() (libVersion string, libVersionNumber int, sourceID string) {
	tls := libc.NewTLS()
	libVersion = libc.GoString(cc.Xsqlite3_libversion(tls))
	libVersionNumber = int(cc.Xsqlite3_libversion_number(tls))
	sourceID = libc.GoString(cc.Xsqlite3_sourceid(tls))
